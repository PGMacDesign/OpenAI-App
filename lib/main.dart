...
import 'package:openai_appp/myactivities/input_activity2.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      //This is the `Toolbar Title`
      home: const MyHomePage(title: 'AI (Kinda)'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            // const Text(
            //   'Press the + Button move to the next activity',
            //
            // ),
            Text(
              'Press the + Button move to the next activity',
